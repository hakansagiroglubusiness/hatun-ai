          ...
          <div className="page studio-page">
            ...
            <div className="studio-layout">
              <section className="config-panel">
                ...
                <div className="field"><label>Referanslar <span>{selectedFiles.length}/8</span></label><label className="upload"><input type="file" multiple accept="image/*,video/*,.pdf" onChange={event => { setSelectedFiles(Array.from(event.target.files || []).slice(0, 8)); setUploadIds([]); }} /><b>＋</b><span>{selectedFiles.length ? selectedFiles.map(file => file.name).join(", ") : tool === "motion" ? "Karakter görseli ve hareket videosu ekle" : "Referans dosyaları ekle"}</span></label></div>
